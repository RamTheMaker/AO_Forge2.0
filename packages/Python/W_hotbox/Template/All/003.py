...
# PySide compatibility (Nuke 11–16)
try:
    # Nuke 16+ (Qt6 / PySide6)
...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_Plate_3.setText(QCoreApplication.translate("Form", u"Reference", None))
...
class md_backdrop(QWidget, Ui_Form):
    def __init__(self):
        ...
        self.pushButton_Plate_3.clicked.connect(self.Reference)
 ...
 #Custom  
    def copy_from_user(self):
       ...
       bd_node['label'].setValue(f'<p align="center">{self.lineEdit.text().upper()}')
       bd_node['appearance'].setValue(1)  # Border mode 
       bd_node['note_font_color'].setValue(0xFFFFFFFF)   
 ...
 #Custom  
    def Cleanup(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<p align="center"> CLEANPLATE')
       bd_node['note_font_color'].setValue(0xFFFFFFFF)
       bd_node['note_font'].setValue('bold')
       bd_node['appearance'].setValue(1)  # Border mode
       bd_node['note_font_size'].setValue(50)
 ...
 #Custom  
    def roto(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<p align="center"> ROTO')
       bd_node['note_font_color'].setValue(0xFFFFFFFF)
       bd_node['note_font'].setValue('bold')
       bd_node['appearance'].setValue(1)  # Border mode
       bd_node['note_font_size'].setValue(50)
 ...
 #Custom  
    def projection(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<p align="center"> PROJECTION')
       bd_node['note_font_color'].setValue(0xFFFFFFFF)
       bd_node['appearance'].setValue(1)  # Border mode
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
 ...
 #ForPlate   
    def Plate(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<p align="center"> PLATE')
       bd_node['note_font'].setValue('bold')
       bd_node['appearance'].setValue(1)  # Border mode
       bd_node['note_font_size'].setValue(50)
       bd_node['note_font_color'].setValue(0xFFFFFFFF)
...
#For Key
    def Keying(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<p align="center"> KEYING')
       bd_node['note_font'].setValue('bold')
       bd_node['appearance'].setValue(1)  # Border mode
       bd_node['note_font_size'].setValue(50)
...
#For Denoise
    def Denoise(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<p align="center"> DENOISE')
       bd_node['appearance'].setValue(1)  # Border mode
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
       bd_node['note_font_color'].setValue(0xFFFFFFFF)
...
#For Despill
    ...
    def Desipill(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<p align="center"> DISPILL')
       bd_node['appearance'].setValue(1)  # Border mode
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
       bd_node['note_font_color'].setValue(0xFFFFFFFF)
...
#For CC
    ...
    def CC(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<p align="center"> COLOR CORRECTION')
       bd_node['appearance'].setValue(1)  # Border mode
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
       bd_node['note_font_color'].setValue(0xFFFFFFFF)
...
#For Transform
    ...
    def Transfrom(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<p align="center"> TRANSFROM')
       bd_node['appearance'].setValue(1)  # Border mode
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
       bd_node['note_font_color'].setValue(0xFFFFFFFF)
...
#For 3d
    ...
    def ThreeD(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<p align="center"> 3D')
       bd_node['appearance'].setValue(1)  # Border mode
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
       bd_node['note_font_color'].setValue(0xFFFFFFFF)
...
#For DMP
    ...
    def DMP(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<p align="center"> DMP')
       bd_node['appearance'].setValue(1)  # Border mode
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
       bd_node['note_font_color'].setValue(0xFFFFFFFF)
...
#For Reference
    ...
    def Reference(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<p align="center"> Reference')
       bd_node['appearance'].setValue(1)  # Border mode
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
       bd_node['note_font_color'].setValue(0xFFFFFFFF)
...
#For Grain
    ...
    def Grain(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<p align="center"> GRAIN')
       bd_node['appearance'].setValue(1)  # Border mode
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
       bd_node['note_font_color'].setValue(0xFFFFFFFF)
...
#For Render
    ...
    def Render(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<p align="center"> RENDER')
       bd_node['appearance'].setValue(1)  # Border mode
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
       bd_node['note_font_color'].setValue(0xFFFFFFFF)
...
#For LensFX
    ...
    def LensFX(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<p align="center"> LENS FX')
       bd_node['appearance'].setValue(1)  # Border mode
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
       bd_node['note_font_color'].setValue(0xFFFFFFFF)
...
#For Alpha
    ...
    def Alpha(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<p align="center"> ALPHA')
       bd_node['appearance'].setValue(1)  # Border mode
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
       bd_node['note_font_color'].setValue(0xFFFFFFFF)
